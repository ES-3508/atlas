    ...
    return (
        ...
        <Row>
            ...
            <div>
                ...
                <div><Link to={{ pathname: `/pri01home/${print.id1}`}}><area target="_blank" alt="FM08" title="FM08" href="1" coords="348,219,372,115" shape="rect"/></Link></div>
                ...
                <div><Link to={{ pathname: `/pri29home/${print.id29}`}}><area target="_blank" alt="WEB4" title="WEB4" href="29" coords="935,252,1051,294" shape="rect"/></Link></div>
                <div><Link to={{ pathname: `/pri30home/${print.id30}`}}><area target="_blank" alt="WEB2" title="WEB2" href="30" coords="938,322,1052,358" shape="rect"/></Link></div>
                <div><Link to={{ pathname: `/pri31home/${print.id31}`}}><area target="_blank" alt="BM02" title="BM02" href="31" coords="757,152,823,152,824,209,996,211,993,165,866,165,865,143,842,143,841,112,757,112" shape="poly"/></Link></div>
                ...
                <div><Link to={{ pathname: `/pri33home/${print.id33}`}}><area target="_blank" alt="UV1" title="UV1" href="33" coords="78,195,79,174,39,173,40,88,13,89,12,194" shape="poly"/></Link></div>
