...
import profile from "../../../../images/operator/defaultuser.png";
...
const ENDPOINT = "http://127.0.0.1:50545";
        ...
        <Card className="sidebarCard"  >
            ...
            <Card.Body> {/* machine info card begin */}
                <Card className="machineInfo" >
                    <Card.Body>
                        <Row>
                            <Col className="machineTitle"> <Card.Title> <Link className="link" to={{ pathname: '/pri07controller' }} >
                                <h4>WEB07</h4> </Link> </Card.Title> </Col>
                            ...
                            <Col >
                                ...
                                <Row>
                                    <p className="text-muted text-center "><h4>User</h4></p>
                                </Row>
                            </Col>
                        </Row>
              ...
              <Table sx={{ minWidth: 20}} aria-label="simple table">
                ...
                <TableHead>
                  ...
                  <TableRow className="sidebarListItem">
                    ...
                    <TableCell sx={{ paddingTop: 1.5 , paddingBottom: 1.5 }} align="center">:</TableCell>
                    <TableCell sx={{ paddingTop: 1.5 , paddingBottom: 1.5 }} align="left">________</TableCell>
                  </TableRow>
                    ...
                    <Table sx={{ minWidth: 0 }} aria-label="simple table">
                        ...
                        <TableHead>
                            ...
                            <TableRow className="sidebarListItem">
                                ...
                                <TableCell sx={{ paddingTop: 1.5 , paddingBottom: 1.5 }, { fontWeight: 'medium' }, { padding: 16 }} align="center">:</TableCell>
                                <TableCell sx={{ padding: 1 }, { fontWeight: 'medium' }, { padding: 16 }} align="left">________</TableCell>
                            </TableRow>
