...
import TimeToTime from '../../PAMachinePage/timeToTime';


const ENDPOINT4 = "http://127.0.0.1:5004";
const ENDPOINT8 = "http://127.0.0.1:5008";
...
var valuebar, shiftvaluebar, topic, pathnmx, hourprogbar, valbar, shiftprogbar, shiftvalbar, timetotimeprogbar1, timetotimeprogbar2, timetotimeprogbar3, 
    ...
    timetotimeprogbar11, timetotimeprogbar12, timetotimeprogbar13, topicpa1, topicpa2, topicpa3, topicpa4, topicpa5, topicpa6, topicpa7, topicpa8, topicpa9 ;
...
export default function Production(props) {
    ...
    const [response, setResponse] = useState(12000);
    const [responsec, setResponsec] = useState();
    const [responsem, setResponsem] = useState();
    const [ valueshift, setValueshift ] = useState();
    

    const [timetotimeprog1, setTimetotimeprog1] = useState(100);
    const [timetotimeprog2, setTimetotimeprog2] = useState(100)
    ...
    //axios
  const baseURL='http://localhost:5000/pa08/time';
  ...
  React.useEffect(() => {
    ...
    if (props.pa01){
        ...
        topicpa1 = 'data/pa01/pa01dash/0101'
        pathnmx = "/pa01productiondocket"
    }
    ...
    if (props.pa02){
        ...
        topicpa2 = 'data/pa02/pa02dash/0202'
        pathnmx = "/pa02productiondocket"
    }
    ...
    if (props.pa03){
        ...
        topicpa3 = 'data/pa03/pa03dash/0303'
        pathnmx = "/pa03productiondocket"
    }
    ...
    if (props.pa04){
        ...
        topicpa4 = 'data/pa04/pa04dash/0404'
        pathnmx = "/pa04productiondocket"

        // const prodtables = [{idtable: "patable4"}];

        // const socket = socketIOClient(ENDPOINT4);
        // // // // console.log(socket, "pa04open", ENDPOINT4)
        // socket.on("json", data => {
    ...
    if (props.pa05){
        ...
        topicpa5 = 'data/pa05/pa05dash/0505'
        pathnmx = "/pa05productiondocket"
    }
    ...
    if (props.pa06){
        ...
        topicpa6 = 'data/pa06/pa06dash/0606'
        pathnmx = "/pa06productiondocket"
    }
    ...
    if (props.pa07){
        ...
        topicpa7 = 'data/pa07/pa07dash/0707'
        pathnmx = "/pa07productiondocket"
    }
    ...
    if (props.pa08){
        ...
        topicpa8 = 'data/pa08/pa08dash/0808'
        pathnmx = "/pa08productiondocket"

        // const prodtables = [{idtable: "patable8"}];

        // const socket = socketIOClient(ENDPOINT8);
        // // // // console.log(socket, "pa08open", ENDPOINT8)
        // socket.on("json", data => {
        //     setResponse(data.dataprodq)
        //     setResponsec(data.datac)
        //     setResponsem(data.datam)
    ...
    if (props.pa09){
        ...
        topicpa9 = 'data/pa09/pa09dash/0909'
        pathnmx = "/pa09productiondocket"
    }
          ...
          client.on('message', (topic, message) => {
            ...
            if(topic === topicpa1){
              ...
              socket.on("json", data => {
                  ...
                  setResponsem(data.datam)
                  setCshiftqt(data.datasshift)
                  setTimetotimeprog1(200)//data.dataprodprog1)
                  setTimetotimeprog2(200)//data.dataprodprog2)
                  setTimetotimeprog3(200)//data.dataprodprog3)
                  setTimetotimeprog4(data.dataprodprog4)
                  setTimetotimeprog5(data.dataprodprog5)
                  setTimetotimeprog6(data.dataprodprog6)
                  setTimetotimeprog7(data.dataprodprog7)
            ...
            if(topic === topicpa2){
              ...
              socket.on("json", data => {
                  ...
                  setResponsem(data.datam)
                  setCshiftqt(data.datasshift)
                  setTimetotimeprog1(data.da)
                  setTimetotimeprog2(5) //(data.dataprodprog2)
                  setTimetotimeprog3(5) //(data.dataprodprog3)
                  setTimetotimeprog4(5)//(data.dataprodprog4)
                  setTimetotimeprog5(data.dataprodprog5)
                  setTimetotimeprog6(data.dataprodprog6)
                  setTimetotimeprog7(data.dataprodprog7)
                  setTimetotimeprog8(data.dataprodprog8)
            ...
            <Card className="production">
                <Card.Header >
                    <Row>
                        ...
                        {/* {prodtables.map((prodtable) => (
                          <map name="factoryXmap"> */}
                          {/* <Link className="link" to={{pathname: `/pa04productiondocket/${prodtable.idtable}`}} > */}
                          {/* <Link className="link" to={{pathname: "/pa04productiondocket"}} > */}
                          <Link className="link" to={{pathname: pathnmx}} >
