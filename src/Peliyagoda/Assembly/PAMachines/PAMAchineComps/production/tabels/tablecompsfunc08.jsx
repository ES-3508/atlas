...
const Prodcomps =() => {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:5000/pa08").then((res) =>{ //http://192.168.8.110:5003/productionsPA08
    ...
    <span style={{padding: '10px', textAlign: 'center'}}><h3>Machine Docket - PA08</h3></span>
