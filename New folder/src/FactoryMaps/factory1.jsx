        ...
        <Row>
            ...
            <div>
                ...
                <map name="factory1map">
                    ...
                    <div>
                        <Link to={{ pathname: `/pa06home/${assem.id6}`}}><area target="_blank" alt="PA06" title="PA06" href="PA06" coords="754,69,628,34" shape="rect"/></Link>
                    </div>
                    <div>
                        <Link to={{ pathname: `/pa07home/${assem.id7}`}}><area target="_blank" alt="PA07" title="PA07" href="PA07" coords="651,128,783,94" shape="rect"/></Link>
                    </div>
                    <div>
                        <Link to={{ pathname: `/pa05home/${assem.id5}`}}><area target="_blank" alt="PA05" title="PA05" href="PA05" coords="642,218,776,179" shape="rect"/></Link>
                    </div>
                    <div>
                        <Link to={{ pathname: `/pa09home/${assem.id9}`}}><area target="_blank" alt="PA09" title="PA09" href="PA09" coords="617,253,776,284" shape="rect"/></Link>
                    </div>
                    <div>
                    ...
                    <div>
                        <Link to={{ pathname: `/pa01home/${assem.id1}`}}><area target="_blank" alt="PA01" title="PA01" href="PA01" coords="629,487,770,520" shape="rect"/></Link>
                    </div>
                    <div>
                        <Link to={{ pathname: `/pa02home/${assem.id2}`}}><area target="_blank" alt="PA02" title="PA02" href="PA02" coords="638,552,770,585" shape="rect"/></Link>
                    </div>
                    <div>
                        <Link to={{ pathname: `/pa03home/${assem.id3}`}}><area target="_blank" alt="PA03" title="PA03" href="PA03" coords="654,659,781,627" shape="rect"/></Link>
                    </div>
                    {/* <div>
