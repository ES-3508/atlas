...
const ENDPOINT = "http://127.0.0.1:50555";
        ...
        <Card className="sidebarCard"  >
            ...
            <Card.Body> {/* machine info card begin */}
                <Card className="machineInfo" >
                    <Card.Body>
                        <Row>
                            <Col className="machineTitle"> <Card.Title> <Link className="link" to={{ pathname: '/pri08controller' }} >
                                <h4>WEB08</h4> </Link> </Card.Title> </Col>
