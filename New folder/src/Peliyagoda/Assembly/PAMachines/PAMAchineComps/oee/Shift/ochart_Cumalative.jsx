...
var pa0M, jsonPa0M, topicx, topicdata;
        ...
        if (topic === topicdata){
          ...
          if (pa0M) {
            ...
            if ((hour === 19) || (hour === 20) || (hour === 21) || (hour === 22) || (hour === 23) || (hour === 0) || (hour === 1) || (hour === 2) || (hour === 3) || (hour === 4)|| (hour === 5) || (hour === 6) || (hour === 7)) {
              ...
              if ((hour === 7) || (hour === 19)) {
                data1 = jsonPa0M.oeeCumalative;
              }
              
              if ((hour === 8) || (hour === 20)) {
                data2 = jsonPa0M.oeeCumalative;
              }
  
              if ((hour === 9) || (hour === 21)) {
                data3 = jsonPa0M.oeeCumalative;
              }
  
              if ((hour === 10) || (hour === 22)) {
                data4 = jsonPa0M.oeeCumalative;
              }
              
              if ((hour === 11) || (hour === 23)) {
                data5 = jsonPa0M.oeeCumalative;
              }
              
              if ((hour === 12) || (hour === 0)) {
                data6 = jsonPa0M.oeeCumalative;
              }
              
              if ((hour === 13) || (hour === 1)) {
                data7 = jsonPa0M.oeeCumalative;
              }
              
              if ((hour === 14) || (hour === 2)) {
                data8 = jsonPa0M.oeeCumalative;
              }
              
              if ((hour === 15) || (hour === 3)) {
                data9 = jsonPa0M.oeeCumalative;
              }
              
              if ((hour === 16) || (hour === 4)) {
                data10 = jsonPa0M.oeeCumalative;
              }
              
              if ((hour === 17) || (hour === 5)) {
                data11 = jsonPa0M.oeeCumalative;
              }
  
              if ((hour === 18) || (hour === 6)) {
                data12 = jsonPa0M.oeeCumalative;
              }
