...
// import ProgressBar, {linearProgressClasses} from "@mui/material/ProgressBar";
// import Typography from '@material-ui/core/Typography';
// import Box from '@material-ui/core/Box';
// import { styled } from "@mui/material/styles";

const ENDPOINT1 = "http://127.0.0.1:5054";
const ENDPOINT2 = "http://127.0.0.1:5055";


var valuebar, shiftvaluebar, topic, hourprogbar, valbar, shiftprogbar, shiftvalbar, timetotimeprogbar1, timetotimeprogbar2, timetotimeprogbar3, 
    ...
    timetotimeprogbar11, timetotimeprogbar12, timetotimeprogbar13;
            ...
            <Card className="production">
                <Card.Header >
                    <Row>
                        ...
                        <Col className="production_icon"><Link className="link" to={{pathname: '/pa04productiondocket'}} ><PlayCircleOutlineIcon/></Link></Col>
                    </Row>
                                    ...
                                    {/* <Card.Body> */}
                                        ...
                                        <div className="cardsy" >
                                                    ...
                                                    <div className={classes.root}>
                                                        <ProgressBar color={hourprogbar} value={(hourprog/valbar)*100} />
                                                    </div>
                                        </div>
                                        </Row>
                                        <Row>
                                ...
                                <Card className="shift">
                                    ...
                                    {/* <Card.Body> */}
                                        ...
                                        <div className="cardsy" >
                                                    ...
                                                    <div className={classes.root}>
                                                        <ProgressBar color={shiftprogbar} value={(shiftprog/shiftvalbar)*100} />
                                                    </div>
                                                </div>
                                        </Row>
                                        <Row>
                        ...
                        <Col className="productCol_2" xs={12} md={6} lg={6} >
                            <Card className="progressbar">
                                ...
                                <Card.Body>
                                    ...
                                    <div className={classes.root}>
                                        <Row>
                                        <Row className="rowWidth"><ProgressBar1 color={timetotimeprogbar1} time={timetv1} value={timetotimeprog1} /></Row>
                                        <Row className="rowWidth"><ProgressBar2 color={timetotimeprogbar2} time={timetv2} value={timetotimeprog2} /></Row>
                                        <Row className="rowWidth"><ProgressBar3 color={timetotimeprogbar3} time={timetv3} value={timetotimeprog3} /></Row>
                                        <Row className="rowWidth"><ProgressBar4 color={timetotimeprogbar4} time={timetv4} value={timetotimeprog4} /></Row>
                                        <Row className="rowWidth"><ProgressBar5 color={timetotimeprogbar5} time={timetv5} value={timetotimeprog5} /></Row>
                                        <Row className="rowWidth"><ProgressBar6 color={timetotimeprogbar6} time={timetv6} value={timetotimeprog6} /></Row>
                                        <Row className="rowWidth"><ProgressBar7 color={timetotimeprogbar7} time={timetv7} value={timetotimeprog7} /></Row>
                                        <Row className="rowWidth"><ProgressBar8 color={timetotimeprogbar8} time={timetv8} value={timetotimeprog8} /></Row>
                                        <Row className="rowWidth"><ProgressBar9 color={timetotimeprogbar9} time={timetv9} value={timetotimeprog9} /></Row>
                                        <Row className="rowWidth"><ProgressBar10 color={timetotimeprogbar10} time={timetv10} value={timetotimeprog10} /></Row>
                                        <Row className="rowWidth"><ProgressBar11 color={timetotimeprogbar11} time={timetv11} value={timetotimeprog11} /></Row>
                                        <Row className="rowWidth"><ProgressBar12 color={timetotimeprogbar12} time={timetv12} value={timetotimeprog12} /></Row>
                                        <Row className="rowWidth"><ProgressBar13 color={timetotimeprogbar13} time={timetv13} value={timetotimeprog12} /></Row>
                                        </Row>
                                    </div>
